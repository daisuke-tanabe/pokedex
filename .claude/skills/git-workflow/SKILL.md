---
name: git-workflow
description: ブランチ戦略、コミット規約、マージ vs リベース、コンフリクト解決、あらゆる規模のチームのための共同開発ベストプラクティスを含むGitワークフローパターン。
---

# Git ワークフローパターン

Gitバージョン管理、ブランチ戦略、共同開発のベストプラクティス。

## 起動タイミング

- 新しいプロジェクトのGitワークフローをセットアップするとき
- ブランチ戦略（GitFlow、トランクベース、GitHub flow）を決めるとき
- コミットメッセージとPR説明を書くとき
- マージコンフリクトを解消するとき
- リリースとバージョンタグを管理するとき
- 新しいチームメンバーにGitの作法をオンボードするとき
