...
ALTER TABLE "species" ADD CONSTRAINT "species_evolution_chain_id_evolution_chains_id_fk" FOREIGN KEY ("evolution_chain_id") REFERENCES "public"."evolution_chains"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
